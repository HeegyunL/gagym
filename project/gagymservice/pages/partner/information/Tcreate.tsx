...
const Tcreate =()=>{
    ...
    const gymCodeRef=useRef() as MutableRefObject<HTMLInputElement>;
    ...
    const handleAddClick = () => {
        ...
        const item : TrainerItem={
            ...
            gymCode:Number(gymCodeRef.current?.value),
        ...
        <Layout>
            <body>
                ...
                <h4 
                 ...
                 <div className="btn-group mt-4 ms-2" role="group" aria-label="Basic checkbox toggle button group"
                ...
                <div className="d-flex mt-4">
                    ...
                    <div style={{width:"70%"}}>
                      <div >
                        <Image className=" mt-3" style={{ width: "100px", height:"100px" }}src={url} alt="trainerPhoto" />               
                        <input
                        style={{width:"67%" }}
